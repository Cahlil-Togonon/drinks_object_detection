...
class KWSDataModule(LightningDataModule):
    ...
    def collate_fn(self, batch):
        ...
        mels = rearrange(mels, 'b c (p1 h) (p2 w) -> b (p1 p2) (c h w)', p1=4, p2=4) # change mels to 4x4 patches
...
if __name__ == "__main__":
    ...
    trainer.fit(model, datamodule=datamodule) #, ckpt_path="./checkpoints/epoch=21-step=30844.ckpt")
